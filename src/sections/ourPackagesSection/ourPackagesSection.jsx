  ...
  return (
    <div id="ourPackages" className={styles.container}>
      ...
      <div className={styles.cardsContainer}>
        <PricingCard minutes={15} image="basic-plan.png" price={50} />
        <PricingCard minutes={20} image="pro-plan.png" price={60} flame />
        <PricingCard minutes={30} image="business-plan.png" price={80} />
